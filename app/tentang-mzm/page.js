    ...
    export default function TentangMzm() {
        ...
        return (
            ...
            {/*misi dan visi*/}
                <section id="visi-misi" className=" py-16 sm:py-20">
                    <div className="max-w-screen-xl mx-auto px-6 sm:px-10">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-start">
                        <div className="md:sticky md:top-24 md:h-[calc(100vh-6rem)] md:flex md:flex-col md:justify-center">
                            <div className="text-center md:text-left mb-6">
                            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#008080] mb-2">Visi Kami</h2>
                            <div className="w-10 h-1 bg-amber-400 rounded-full mx-auto md:mx-0" />
                            </div>
                            <div className="bg-white rounded-3xl p-8 sm:p-10 shadow-sm border border-gray-100">
                            <p className="text-gray-600 text-base sm:text-lg leading-relaxed font-medium italic text-center">
                ...
                {/*Kantor pusat*/}
                <section className="bg-gray-50 border-t border-gray-200 py-16 px-6 sm:px-10">
